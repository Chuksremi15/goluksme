...
const Campaign: React.FC = () => {
  ...
  return (
    <PageWrapper>
      ...
      <div className="mt-2 shadow rounded-lg px-6 pt-4">
        <div className="flex justify-between items-center">
          <h3 className="text-xl font-head">{campaign.title}</h3>
          {/* {truncateAddress(campaign.creator)} */}
          <CopyableAddress address={campaign.creator} />
        </div>
        <img
          src={img1}
        ...
        <p className="text-sm  text-gray-600 mt-2 font-body">
          Hi as everybody is aware Christopher potter was tragically killed
          while away watching his beloved rangers,let’s try and get some momey
          together to help with any costs needed, his funeral or getting him
          home or just to help his wife and kids,let’s dig deep all donations
        ...
        <div className="mt-4 flex justify-between">
          <div>
            <h3 className="font-head text-2xl">£162,920 raised</h3>
            <h3 className="font-body text-base">£300,920 target</h3>
          </div>
          <div>
            <div className="relative ">
              <svg className="w-18 h-18" viewBox="0 0 100 100">
                ...
                {/* Progress circle */}
                <circle
                  className="stroke-blue-500 transform -rotate-90 origin-center transition-all duration-500"
                  cx="50"
                  cy="50"
                  r="45"
                  fill="none"
                  ...
                  strokeLinecap="round"
                  strokeDasharray={`${
                    (campaign.currentAmount / campaign.goal) * 283
                  } 283`}
                />
              </svg>
